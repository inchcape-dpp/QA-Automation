...
${Retail_RegistrationPostalAddLine1Label}    //form//div[@formgroupname='deliveryAddress']//div[@class='col-12' or @class='col-md-12']//*[@formcontrolname='addressLine1']/preceding-sibling::*[self::span[contains(text(),'Address Line 1')] or self::label//span[contains(text(),'Address Line 1') or contains(text(),'地址第一行')]]
${Retail_RegistrationPostalAddLine2Label}    //form//div[@formgroupname='deliveryAddress']//div[@class='col-12' or @class='col-md-12']//*[@formcontrolname='addressLine2']/preceding-sibling::*[contains(text(),'Address Line 2') or contains(text(),'地址第二行') ]
