...
TC-007 - User should be able to view All Parts Page
    [Tags]    TC027    All Parts Page
    run keyword and continue on failure    User should be able to view All Parts Page
    run keyword and continue on failure    TC Sleep

TC-008 - User should be able to view Results per page filter on top
    [Tags]    TC027    All Parts Page
    run keyword and continue on failure    User should be able to view Results per page filter on top

TC-009 - User should be able to filter products by 20 results per page
    [Tags]    TC027    All Parts Page
    run keyword and continue on failure    User should be able to click Results per page filter on top
    run keyword and continue on failure    User should be able to select 20 Results per page filter on top

TC-010 - User should be able to filter products by 50 results per page
    [Tags]    TC027    All Parts Page
    run keyword and continue on failure    User should be able to click Results per page filter on top
    run keyword and continue on failure    User should be able to select 50 Results per page filter on top

TC-011 - User should be able to filter products by 100 results per page
    [Tags]    TC027    All Parts Page
    run keyword and continue on failure    User should be able to click Results per page filter on top
    run keyword and continue on failure    User should be able to select 100 Results per page filter on top
