...
Resource  ../../../../../Resource/testdata/Retail/HK_Config/D1/HK_D1_Gold_Config.robot
...
TC-009 - User should be albe to select Credit Cart Payment
    [Tags]    Checkout Page
...
TC-010 - User should be able to input card details
    [Tags]    Checkout Page
...
TC-011 - User should be able to click continue payment
    [Tags]    Checkout Page
...
TC-012 - User should be able to input otp
    [Tags]    Checkout Page
    run keyword and continue on failure    User should be able to Input OTP

TC-013 - User should be able to click Submit button on 2C2P
    [Tags]    Checkout Page
    run keyword and continue on failure    User should be able to click Submit button on 2C2P

TC-014 - User should be able to view place order in HK Retail Place Order Page
    [Tags]    Checkout Page
    run keyword and continue on failure    TC Sleep
    run keyword and continue on failure    TC Sleep
...
TC-015 - User should be able to filter product
    [Tags]    All Products Page
    run keyword and continue on failure    User should be able to view All Products Page in HK Retail Home Page
    run keyword and continue on failure    User should be able to Filter Products by Stocks

TC-016 - User should be able to add to cart random item in Retail Product Page
    [Tags]    All Products Page
    run keyword and continue on failure    User should be able to add to cart random item in Retail Product Page
    run keyword and continue on failure    User should be able to add to cart random item in Retail Product Page
    run keyword and continue on failure    User should be able to add to cart random item in Retail Product Page

TC-017 - User should be able to process Re-Order in Retail Account Order Details Page
    [Tags]    Re-Order Process
    run keyword and continue on failure    User should be able to Go to Home page
    run keyword and continue on failure    User should be able to view shopping cart pop up modal
    run keyword and continue on failure    User should be albe to delete all items from shopping cart pop up modal
...
TC-018 - User should be able to view payment method in HK Retail Checkout Page
    [Tags]    Checkout Page
    run keyword and continue on failure    User should be able to view payment method in HK Retail Checkout Page

TC-019 - User should be albe to select COD Payment
    [Tags]    Checkout Page
    run keyword and continue on failure    User should be albe to select COD Payment

TC-020 - User should be able to click place order button in Retail Checkout Page
    [Tags]    Checkout Page
    Reload Page
