...
*** Test Cases ***
Test Setup  Run Keywords   Open Chrome Browser AU
Screen Shot DIR  Run Keywords    Dealer Screent Shot DIR AU

TC Sleep
    [Tags]    Sleep    TC Sleep AU
    run keyword and continue on failure    TC Sleep AU
